...
import { RankAndCount } from "@whitespaces/schemas/users";
import { roundTo2 } from "@whitespaces/util/numbers";
...
export function updateTitle(title?: string): void {
  ...
  if (title === undefined || title === "") {
    document.title =
      local + "Whitespaces | A minimalistic, customizable typing test";
  } else {
