...
import { Badge, CustomTheme } from "@whitespaces/schemas/users";
import { Difficulty } from "@whitespaces/schemas/configs";
import {
  Mode,
  Mode2,
  PersonalBest,
...
import { FunboxMetadata } from "./utils/local/funbox";
...
import { Connection } from "@whitespaces/schemas/connections";
import {
  setLastResult,
...
export async function initSnapshot(): Promise<Snapshot | false> {
  ...
  try {
    ...
    // const userDataTags: Whitespacess.UserTagWithDisplay[] = userData.tags ?? [];
