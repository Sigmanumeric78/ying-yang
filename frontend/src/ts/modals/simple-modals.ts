...
import { GenerateDataRequest } from "@whitespaces/contracts/dev";
import {
  PasswordSchema,
  UserEmailSchema,
  UserNameSchema,
...
list.removePasswordAuth = new SimpleModal({
  ...
  inputs: [
    {
      type: "checkbox",
      label: `I understand I will lose access to my Whitespaces account if my Google/GitHub account is lost or disabled.`,
    },
  ],
