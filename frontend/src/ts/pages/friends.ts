...
import { PersonalBest } from "@whitespaces/schemas/shared";
...
import { Friend, UserNameSchema } from "@whitespaces/schemas/users";
  ...
  inputs: [
    {
      ...
      validation: {
        ...
        isValid: remoteValidation(
          ...
          { check: (data) => !(data as any).available || "Unknown user" },
        ),
        debounceDelay: 1000,
      },
    },
