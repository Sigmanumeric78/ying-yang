import {
  ...
  UserProfileDetails,
  UserTag,
} from "@whitespaces/schemas/users";
import { getDefaultConfig } from "./default-config";
import { Mode } from "@whitespaces/schemas/shared";
import { Result } from "@whitespaces/schemas/results";
import { Difficulty, FunboxName } from "@whitespaces/schemas/configs";
import {
  ModifiableTestActivityCalendar,
  TestActivityCalendar,
} from "../elements/test-activity-calendar";
import { Preset } from "@whitespaces/schemas/presets";
import { Language } from "@whitespaces/schemas/languages";
import { ConnectionStatus } from "@whitespaces/schemas/connections";
