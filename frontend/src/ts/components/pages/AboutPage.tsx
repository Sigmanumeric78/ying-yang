  ...
  return (
    <div class="content-grid grid gap-8">
      ...
      <section>
        ...
        <p>
          Whitespaces is a minimalistic and customizable typing test. It features
          ...
          and more. Whitespaces attempts to emulate the experience of natural
      ...
      <section>
        ...
        <p>
          If you encounter a bug or have a feature request, please create an
          issue on GitHub.
        </p>
      </section>
      <div></div>
      <section>
        ...
        <p>
          <Button
            type="text"
            text="Contributors"
            href="https://github.com/whitespacesgame/whitespaces/graphs/contributors"
            class="p-0 pt-2 pr-2 pb-2"
          />
