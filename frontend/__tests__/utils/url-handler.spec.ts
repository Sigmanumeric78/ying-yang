...
import { Difficulty, Mode, Mode2 } from "@whitespaces/schemas/shared";
...
import { FunboxName } from "@whitespaces/schemas/configs";
import { CustomTextSettings } from "@whitespaces/schemas/results";
