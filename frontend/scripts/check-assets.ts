 ...
 * bun check-assets (npm run check-assets)
 * bun vaildate-json quotes others(npm run vaildate-json quotes others)
 * bun check-assets challenges fonts -p (npm run check-assets challenges fonts -- -p)
 */
...
import {
  ...
  LanguageSchema,
} from "@whitespaces/schemas/languages";
import { Layout, ThemeName } from "@whitespaces/schemas/configs";
import { LayoutsList } from "../src/ts/constants/layouts";
import { KnownFontName } from "@whitespaces/schemas/fonts";
import { Fonts } from "../src/ts/constants/fonts";
import { themes, ThemeSchema, ThemesList } from "../src/ts/constants/themes";
import { z } from "zod";
import { ChallengeSchema, Challenge } from "@whitespaces/schemas/challenges";
import { LayoutObject, LayoutObjectSchema } from "@whitespaces/schemas/layouts";
import { QuoteDataSchema, QuoteData } from "@whitespaces/schemas/quotes";
